...
def dataset_pipeline(data, target, tokenizer_bert, model_bert, pca, tfidf, scaler, index_train=None, index_val=None, bert=False, cv=True, is_test=False, device='cpu'):
    """
